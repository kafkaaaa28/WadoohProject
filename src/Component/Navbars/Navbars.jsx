...
export default function Navbars({ setIsOpen }) {
          ...
          <div className="flex items-center justify-between h-[65px]">
            ...
            <div className="hidden md:flex gap-12 items-center text-focus-in">
              <ul className="flex gap-12">
                <li className="relative  cursor-pointer text-gray-500 hover:text-[#1E6D3C] transition-colors duration-300 li-underline">Tentang</li>
                <li className="relative cursor-pointer text-gray-500 hover:text-[#1E6D3C] transition-colors duration-300 li-underline">Cara Kerja</li>
                <li className="relative cursor-pointer text-gray-500 hover:text-[#1E6D3C] transition-colors duration-300 li-underline">Fitur</li>
                <li className="relative cursor-pointer text-gray-500 hover:text-[#1E6D3C] transition-colors duration-300 li-underline">Team</li>
              </ul>
            </div>
