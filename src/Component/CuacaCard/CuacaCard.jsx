      ...
      <div className="w-[360px] h-[600px] rounded-[50px] bg-black shadow-2xl p-3 relative border-4 border-gray-700">
        ...
        <div className="bg-white rounded-[36px] w-full h-full overflow-hidden relative">
          <div className="h-[600px] bg-center w-full bg-cover px-4" style={{ backgroundImage: `url(${hero3})` }}>
            ...
            <div className={`w-[300px] mx-auto flex flex-col justify-between   animate-fade-in transition-all duration-1000 ease-out origin-top  absolute bottom-[10px] ${Pengaturan ? 'h-[220px] rounded-[50px] bg-white/80' : 'h-[50px]'}`}>
              ...
              {Pengaturan && (
                <div className=" flex flex-col gap-3 h-full px-8">
                  <div className="flex gap-4">
                    <div className="bg-white text-[#8EB39D] shadow-xl hover:bg-[#568A69] hover:text-white transition-colors duration-500 ease-in-out w-[50%] flex flex-col justify-center items-center cursor-pointer rounded-lg h-[40px]">
                      <MdDarkMode />
                      <p className="text-[12px]">Dark Mode</p>
                    </div>
                    <div className="bg-white text-[#8EB39D] shadow-xl hover:bg-[#568A69] hover:text-white transition-colors duration-500 ease-in-out  w-[50%] flex flex-col justify-center items-center cursor-pointer rounded-lg h-[40px]">
                      <MdLightMode />
                  ...
                  <div className="bg-white text-[#8EB39D] shadow-xl hover:bg-[#568A69] hover:text-white transition-colors duration-500 ease-in-out  h-[40px] rounded-lg flex items-center justify-center">Dashboard</div>
                  <div onClick={() => navigate('/login')} className="bg-white text-[#8EB39D] shadow-xl hover:bg-[#568A69] hover:text-white transition-colors duration-500 ease-in-out  h-[40px] rounded-lg flex items-center justify-center">
                    Login
                  </div>
                </div>
              )}
