...
const Jumbotron = () => {
  ...
  const clipStyle = isDesktop
    ? {
        clipPath:
          "polygon(0 0, 100% 0, 100% calc(100% - 80px), calc(100% - 700px) calc(100% - 80px), calc(100% - 800px) 100%, 0 100%)",
      }
    : {}; 
    ...
    <div className="bg-white p-5">
      ...
      >
        <div className="flex flex-col gap-2 lg:flex-row lg:justify-between w-full">
          <div
            className="lg:w-[500px] ml-[20px]"
            data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="1000"
          >
            <p className="text-white font-bold uppercase text-[25px] md:text-[40px]">
              Dari Ladang ke Teknologi Pertanian Cerdas dengan AI
            </p>
          </div>
  ...
  <div className="w-[350px] text-center z-40  mt-[10px]">
    <p className="font-bold">
      Memperkuat tangan petani dengan kecanggihan AI untuk hasil panen
      maksimal dan lingkungan yang lestari.
    </p>
  </div>
